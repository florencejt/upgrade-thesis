...
\documentclass[12pt,phd,a4paper,oneside,pdftex,hidelinks]{ucl_thesis}
...
\include{CoxHazards}
\include{FusilliDevelopment}
% \include{FusilliOnOpenData}
\include{FusilliOnMND}
