...
Figure~\ref{fig:fusilli_taxonomy} is a diagram taken from the review, which shows the general architecture differences between the models, and Table~\ref{tab:fusilli_taxonomy} includes descriptions of the categories.
