...
\begin{itemize}\itemsep{-0.5em}
    \item Data: The user's data, which must be in the form of a .csv file for tabular data, and .pt files for images.
    \item Task: The task that the user wants to perform, which can be either regression or classification (binary or multiclass).
    \item Models: The models that the user wants to compare, which can be any of the models included in Fusilli.
    \item Output: The output directory for the trained models and the results of the experiments.
\end{itemize}

The user can also specify experiment specifics, which are set to default values if not specified.
These are:
\begin{itemize}\itemsep{-0.5em}
