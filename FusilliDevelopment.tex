...
In the field of machine learning, multimodal data can be integrated as it was in the Cox model, by concatenating the data before inputting into the model, or by using more complex methods that aim to capture the relationships between the modalities.
These techniques are known as multimodal data fusion.
