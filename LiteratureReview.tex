...
A 2022 revisit using deep learning models found similar performance to classical ML~\cite{pancottiDeepLearningMethods2022}, but a study using PRO-ACT data to classify short versus long survival found that deep learning models did outperform classical ML models~\cite{papaizEnsembleimbalancebasedClassificationAmyotrophic2024}.
