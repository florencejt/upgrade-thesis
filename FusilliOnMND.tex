...
Furthermore, Figure~\ref{fig:tsne} shows the separability of the data in two dimensions using t-distributed stochastic neighbour embedding (TSNE) for clinical, imaging, and multimodal features.
