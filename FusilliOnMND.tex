...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth](figures/both_site_together_balanced_accuracy_violin)
    \caption{Balanced accuracy of the different models on the MND data.}
...
\begin{figure}
    ...
    \caption{Effect of training on one site and testing on the other on the balanced accuracy of the different models.}
